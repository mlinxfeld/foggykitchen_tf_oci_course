...
variable "DBNodeShape" {
  description = "Shape of the Primary Database System Node"
  default     = "VM.Standard.E4.Flex"
}


variable "DBStandbyNodeShape" {
  description = "Shape of the Standby Database System Node"
  default     = "VM.Standard.E4.Flex"
}
...
variable "DBStandbySystemDisplayName" {
  description = "Standby Database System Display Name"
  default     = "FoggyKitchenDBStandbySystem"
}

variable "DBNodeHostName" {
  description = "Primary Database System Host Name"
  default     = "foggydbpri"
}

variable "DBStandbyNodeHostName" {
  description = "Standby Database System Host Name"
  default     = "foggydbstb"
}