...
# SpokeVCN2
resource "oci_core_virtual_network" "FoggyKitchenSpokeVCN2" {
  provider       = oci.acceptor
  cidr_block     = var.VCN-CIDR2
  dns_label      = "FKSpokeVCN2"
  compartment_id = oci_identity_compartment.ExternalCompartment.id
  display_name   = "FoggyKitchenSpokeVCN2"
}
...
# Route Table for SpokeVCN2
resource "oci_core_route_table" "FoggyKitchenRouteTableSpokeVCN2" {
  provider       = oci.acceptor
  compartment_id = oci_identity_compartment.ExternalCompartment.id
  vcn_id         = oci_core_virtual_network.FoggyKitchenSpokeVCN2.id
  display_name   = "FoggyKitchenRouteTableSpokeVCN2"
...
# Route Table for SpokeVCN3
resource "oci_core_route_table" "FoggyKitchenRouteTableSpokeVCN3" {
  provider       = oci.acceptor
  compartment_id = oci_identity_compartment.ExternalCompartment.id
  vcn_id         = oci_core_virtual_network.FoggyKitchenSpokeVCN3.id
  display_name   = "FoggyKitchenRouteTableSpokeVCN3"
...
# Route Table for SpokeVCN4
resource "oci_core_route_table" "FoggyKitchenRouteTableSpokeVCN4" {
  provider       = oci.acceptor
  compartment_id = oci_identity_compartment.ExternalCompartment.id
  vcn_id         = oci_core_virtual_network.FoggyKitchenSpokeVCN4.id
  display_name   = "FoggyKitchenRouteTableSpokeVCN4"
...
# Security List for ICMP in SpokeVCN2
...
# Security List for SSH in SpokeVCN2
...
# SpokeSubnet0 (public) in SPOKEVCN2
resource "oci_core_subnet" "FoggyKitchenSpokeSubnet0" {
  provider     = oci.acceptor
  cidr_block   = var.SpokeSubnet0-CIDR
  display_name = "FoggyKitchenSpokeSubnet0"
  dns_label    = "FoggyKitchenN5"
  #  prohibit_public_ip_on_vnic = true
  compartment_id    = oci_identity_compartment.ExternalCompartment.id
  vcn_id            = oci_core_virtual_network.FoggyKitchenSpokeVCN2.id
  route_table_id    = oci_core_route_table.FoggyKitchenRouteTableSpokeVCN2.id
...
resource "oci_core_subnet" "FoggyKitchenSpokeSubnet1" {
  ...
  compartment_id    = oci_identity_compartment.ExternalCompartment.id
  vcn_id            = oci_core_virtual_network.FoggyKitchenSpokeVCN3.id
  route_table_id    = oci_core_route_table.FoggyKitchenRouteTableSpokeVCN3.id
...
resource "oci_core_subnet" "FoggyKitchenSpokeSubnet2" {
  ...
  compartment_id    = oci_identity_compartment.ExternalCompartment.id
  vcn_id            = oci_core_virtual_network.FoggyKitchenSpokeVCN4.id
  route_table_id    = oci_core_route_table.FoggyKitchenRouteTableSpokeVCN4.id
